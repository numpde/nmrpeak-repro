...
If a required peak field is not reported, do not infer it. Ignore candidate
structures, identifiers, provenance, evaluation, and decode metadata. A
reported formula or peak value remains source data even when it appears
chemically unusual. Do not cross-check the formula and peaks for scientific
consistency.
